...
export default function Home() {
  const [view,setView]=useState<'home'|'exam'|'result'|'history'>('home');
...
function History({attempts,error,loading,onBack,onStart}:{attempts:Attempt[];error:string;loading:boolean;onBack:()=>void;onStart:()=>void}){
